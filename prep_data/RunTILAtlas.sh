...
quick agg-countmatrix input/$sample/concat_fake_true_fragments.sorted.tsv -g input/$chromsize_file -p input/$bedfile --max-fragsize 999999999 -o counts/$sample'_vTIL'/ && echo "Done!"; done
